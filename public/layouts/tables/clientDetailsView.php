<?php
	$full_client_result = find_client_by_id($_GET['client_id']);
?>
			...
			<tbody>
				   <?php while($client = mysqli_fetch_assoc($client_set)) { ?>
				      <tr>
				        ...
				        <td><a class="btn btn-sm btn-primary" href="new_location.php?id=<?php echo urlencode($client["id"]); ?>">Add location</a></td>
